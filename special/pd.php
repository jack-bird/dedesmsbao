...
<script type="text/javascript" src="js/jquery.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        function editCode(that) {
            that.src = "plugin/verify_code.php?" + Math.random();
        }
            ...
            <div class="adv">
                <div class="test">
                    <form method="post" action="./test.php" id="test_form">
                        <label><input id="phone_input" type="text" value="" placeholder="请输入手机号 以便于您的测试我们的验证短信" name="test"/></label>

                        <input type="text" value="" name="verify_code" id="code_input" placeholder="请输入验证码" />
                        <img id="code" src="plugin/verify_code.php" />
...
<div class="subject2">
        ...
        <p align="center" style="padding-bottom: 10px;">
            <a href="/reg" class="btn btn-large btn-solid" style="font-weight:normal;  background:#f58b3c; color:#ffffff;">开始注册，即送体验短信</a>
                                ...
                                <ul class="tools">
                                    <li>
                                        <img src="images/shipper-step-one.png">
                                        <h4>
                                            <a href="/reg">在线注册</a>
                                        </h4>
                                    </li>
                                    <li>
                                        <img src="images/shipper-step-two.png">
                                        <h4>
                                            <a href="/fee">在线充值</a>
                                        </h4>
                                    </li>
                                    <li>
                                        <img src="images/shipper-step-three.png">
                                        <h4>
...
<section class="home-row-3">
                ...
                <div class="pi-col-xs-3 pi-padding-bottom-40">
                    <div class="pi-icon-box-vertical pi-icon-box-vertical-icon-bigger pi-text-center">
                        <div class="pi-icon-box-icon pi-icon-box-icon-circle pi-icon-box-icon-base" style="background: #bbea76;">
                            <img src="images/pig-lined-white.png" alt=""></div>
                ...
                <div class="pi-col-xs-3 pi-padding-bottom-40">
                    <div class="pi-icon-box-vertical pi-icon-box-vertical-icon-bigger pi-text-center">
                        <div class="pi-icon-box-icon pi-icon-box-icon-circle pi-icon-box-icon-base" style="background: #77DD77;">
                            <img src="images/lightning.png" alt=""></div>
                ...
                <div class="pi-col-xs-3 pi-padding-bottom-40">
                    <div class="pi-icon-box-vertical pi-icon-box-vertical-icon-bigger pi-text-center">
                        <div class="pi-icon-box-icon pi-icon-box-icon-circle pi-icon-box-icon-base" style="background: #5ED5A4;">
                            <img src="images/Success ratio.png" alt=""></div>
                ...
                <div class="pi-col-xs-3 pi-padding-bottom-40">
                    <div class="pi-icon-box-vertical pi-icon-box-vertical-icon-bigger pi-text-center">
                        <div class="pi-icon-box-icon pi-icon-box-icon-circle pi-icon-box-icon-base" style="background: #49C0C0;">
                            <img src="images/contacts.png" alt=""></div>
        ...
        <ul class="advantage"> 
            ...
            <li style=" margin-top:50px;">
                <div class="pi-col-xs-3 pi-padding-bottom-40"> 
                    <div class="pi-icon-box-vertical pi-icon-box-vertical-icon-bigger pi-text-center">
                        <div class="pi-icon-box-icon pi-icon-box-icon-circle pi-icon-box-icon-base" style="background: #bbea76;">
                            <img src="images/information.png" alt=""></div>
            ...
            <li style=" margin-top:50px;">
                <div class="pi-col-xs-3 pi-padding-bottom-40">
                    <div class="pi-icon-box-vertical pi-icon-box-vertical-icon-bigger pi-text-center">
                        <div class="pi-icon-box-icon pi-icon-box-icon-circle pi-icon-box-icon-base" style="background: #77DD77;">
                            <img src="images/coin-lined-white.png" alt=""></div>
            ...
            <li style=" margin-top:50px;">
                <div class="pi-col-xs-3 pi-padding-bottom-40">
                    <div class="pi-icon-box-vertical pi-icon-box-vertical-icon-bigger pi-text-center">
                        <div class="pi-icon-box-icon pi-icon-box-icon-circle pi-icon-box-icon-base" style="background: #5ED5A4;">
                            <img src="images/Perfect interface.png" alt=""></div>
            ...
            <li style=" margin-top:50px;">
                <div class="pi-col-xs-3 pi-padding-bottom-40">
                    <div class="pi-icon-box-vertical pi-icon-box-vertical-icon-bigger pi-text-center">
                        <div class="pi-icon-box-icon pi-icon-box-icon-circle pi-icon-box-icon-base" style="background: #49C0C0;">
                            <img src="images/trophy.png" alt=""></div>
    ...
    <div class="advantage2">
        <h2> 我们的客户</h2>
        <p align="center">
           <img src="images/kh-logo.gif" width="893" height="185" alt="短信宝 客户案例" />
        </p>
    </div>
</div>
<!--主体内容结束-->
<div  class="footer ">
    <div  class="webContainer">
        ...
        <div  class="footer-qcode">
            <img  class="lazy"  src="images/qr-code.png"  height="141">
        </div>
    </div>
</div>
